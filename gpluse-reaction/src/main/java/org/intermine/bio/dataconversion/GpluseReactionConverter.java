 ...
 */
public class GpluseReactionConverter extends BioFileConverter
{
    protected static final Logger LOG = Logger.getLogger(GpluseReactionConverter.class);
    private static final String PROP_FILE = "gpluse_config.properties";
     ...
     */
    public GpluseReactionConverter(ItemWriter writer, Model model) {
        super(writer, model, "GPLUSE", "GPLUSE reactions data set");
        //readConfig();
    }
     ...
     */
    public void setGpluseOrganisms(String taxonIds) {
    ...
    public void process(Reader reader) throws Exception {
        ...
        while (lineIter.hasNext()) {
            ...
            if (currentFile.getName().startsWith("reaction_title")) {
                ...
                // first chunck of the file name
		String taxonId = matcher.group(1);
                //String organism = matcher.group(1);
		//? Organism/String organism = getOrganism(taxon_id);

		// get rid of the next 4 lines
		/*
    ...
    private Item getGene(String geneCG, String taxonId, ReferenceList referenceList)
        ...
        if (gene == null) {
            ...
            //gene.setReference("taxonId", taxonId);
    ...
    private void processReaction(String[] line) throws ObjectStoreException {
        ...
        reaction.setAttribute("name", name);
          //reaction.setReference("organism", getOrganism(taxon_id));
