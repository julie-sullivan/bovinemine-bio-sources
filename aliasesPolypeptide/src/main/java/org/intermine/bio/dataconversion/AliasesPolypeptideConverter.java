 ...
 * @author
 */
public class AliasesPolypeptideConverter extends BioFileConverter
{
    //
     ...
     */
    public AliasesPolypeptideConverter(ItemWriter writer, Model model) {
    ...
    public void process(Reader reader) throws Exception {
        ...
        while (lineIter.hasNext()) {
            ...
            if (geneItemMap.containsKey(genePrimaryIdentifier)) {
                ...
                geneItem = createItem("Polypeptide");
