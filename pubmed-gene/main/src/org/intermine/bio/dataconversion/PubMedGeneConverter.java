...
public class PubMedGeneConverter extends BioFileConverter
{
    ...
    private Item getGene(String identifier, String taxonId) {
	    ...
	    /*
            ...
            //gene.setAttribute("source","RefSeq-ARS1");
            //gene.setAttribute("source","RefSeq-Oar_v4.0");
            //gene.setAttribute("source","RefSeq-ARS-UCD1.2");
            //gene.setAttribute("source","Ensembl93");
            	
		//9913
		gene.setAttribute("source","RefSeq-UMD3.1.1");
		//9913
		//gene.setAttribute("source","RefSeq-ARS-UCD1.2");
		//9940
		//gene.setAttribute("source","RefSeq-Oar_v3.1");
		//9940
		//gene.setAttribute("source","RefSeq-Oar_v4.0");
		//9925
		//gene.setAttribute("source","RefSeq-ARS1");
