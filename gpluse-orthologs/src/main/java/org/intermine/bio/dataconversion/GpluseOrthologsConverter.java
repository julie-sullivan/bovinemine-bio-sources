...
public class GpluseOrthologsConverter extends BioFileConverter
{
    ...
    private static final String DATASET_TITLE = "GplusE data set";
    private static final String DATA_SOURCE_NAME = "gpluse-orthologs";

    private static final String PROP_FILE = "gpluse-orthologs_config.properties";
   ...
   // private String lastCommonAncestor = null;
     ...
     */
    public void setGpluseorthologsVersion(String version) {
