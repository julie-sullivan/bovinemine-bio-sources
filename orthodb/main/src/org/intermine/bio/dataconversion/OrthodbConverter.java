...
public class OrthodbConverter extends BioFileConverter
{
    ...
    public void process(Reader reader) throws Exception {
        ...
        */
	    ...
	    //System.out.println(" " + bits[1] + " " +  bits[2]  + " " +  bits[3]  + " " + bits[4]  + " " + bits[5]  + " " + bits[6]);	
	    ...
	    String lastCommonAncestor = bits[6];
            ...
            String taxonId = bits[5]; // bits[4] is the long string of taxon Ids

            if (taxonId != null && isValid(taxonId)) {
		System.out.println("VALID TAXON:  " + taxonId);
		System.out.println(" " + bits[1] + " " +  bits[2]  + " " +  bits[3]  + " " + bits[4]  + " " + bits[5]  + " " + bits[6]);
		    ...
		    System.out.println("BAD GENE!!! " +  bits[1] + " " +  bits[2]  + " " +  bits[3]  + " " + bits[4]  + " " + bits[5]  + " " + bits[6]);
                    // bad gene, keep going
                    continue;
                }
                ...
                if (gene == null) {
                    ...
                    //gene = new GeneHolder(resolvedIdentifier, taxonId, clusterId);
    ...
    private void processHomologuePair(GeneHolder gene, GeneHolder homologue)
		...
		System.out.println(" NOT VALID PAIR ");
            return;
        }
        ...
        if (refId1 == null || refId2 == null || refId1.equals(refId2)) {
            ...
            System.out.println(" NO ID RESOLVER MATCH " + geneTaxonId + homologueTaxonId);
            return;
        }

        final String type = (geneTaxonId.equals(homologueTaxonId) ? PARALOGUE : ORTHOLOGUE);
        createHomologue(refId1, refId2, type, gene.getClusterId(), gene.getlastCommonAncestor());
        //createHomologue(refId1, refId2, type, gene.getClusterId());
    }
    ...
    //private void createHomologue(String gene1, String gene2, String type, String clusterId)
        throws ObjectStoreException {
    ...
    private boolean isValid(String taxonId) {
	   ...
	   System.out.println("no config for homologue");
        ...
        // not found in config
        System.out.println(" NOT FOUND IN CONFIG ");
        return false;
    }
    ...
    private String resolveGene(String identifier, String taxonId) {
        if (rslv == null || !rslv.hasTaxon(taxonId)) {
            ...
            System.out.println(" NO ID RESOLVER AVAILABLE ");
            return identifier;
        }
	...
	private String lastCommonAncestor;
        ...
        //protected GeneHolder(String identifier, String taxonId, String clusterId) {
